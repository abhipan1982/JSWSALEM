...
namespace PE.HMIWWW.ViewModel.System
{
  public class VM_Account : VM_Base
  {
    ...
    [SmfDisplay(typeof(VM_Account), "FirstName", "NAME_FirstName")]
    ...
    [SmfDisplay(typeof(VM_Account), "UserName", "NAME_UserName")]
    [StringLength(256, MinimumLength = 1, ErrorMessage = "", ErrorMessageResourceName = "GLOB_StringLength",
      ErrorMessageResourceType = typeof(VM_Resources))]
    [Required(ErrorMessageResourceName = "FORM_ATTRIBUTE_FieldIsRequired",
      ErrorMessageResourceType = typeof(VM_Resources))]
    public virtual String UserName { get; set; }

    [SmfDisplay(typeof(VM_Account), "LastName", "NAME_LastName")]
    [StringLength(50, MinimumLength = 1, ErrorMessage = "", ErrorMessageResourceName = "GLOB_StringLength",
      ErrorMessageResourceType = typeof(VM_Resources))]
    [Required(ErrorMessageResourceName = "FORM_ATTRIBUTE_FieldIsRequired",
      ErrorMessageResourceType = typeof(VM_Resources))]
    ...
    [SmfDisplay(typeof(VM_Account), "JobPosition", "NAME_JobPosition")]
    ...
    [SmfDisplay(typeof(VM_Account), "LeftToRight", "NAME_LeftToRight")]
    public virtual bool LeftToRight { get; set; }

    [SmfDisplay(typeof(VM_Account), "RolesList", "NAME_RoleList")]
    [UIHint("RolesEditor")]
    public virtual List<VM_Role> RolesList { get; set; }

    [SmfDisplay(typeof(VM_Account), "Superuser", "NAME_Superuser")]
    public bool Superuser { get; set; }

    [SmfDisplay(typeof(VM_Account), "LeaderId", "NAME_Leader")]
    public virtual long? LeaderId { get; set; }

    [SmfDisplay(typeof(VM_Account), "FullName", "NAME_FullName")]
    public virtual String FullName { get; set; }

    [SmfDisplay(typeof(VM_Account), "LanguageId", "NAME_LanguageId")]
    public virtual long? LanguageId { get; set; }

    [SmfDisplay(typeof(VM_Account), "ReportUser", "NAME_ReportUser")]
    public virtual bool ReportUser { get; set; }

    [SmfDisplay(typeof(VM_Account), "Roles", "NAME_RoleList")]
    [UIHint("RolesEditor")]
    ...
    public VM_Account(User user)
    {
      ...
      Roles = user.Roles.Select(t => new TextLookupModel(t.Id, t.Name));
