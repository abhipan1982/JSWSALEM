...
namespace PE.HMIWWW.ViewModel.Module.Lite.WeighingMonitor
{
  public class VM_WeighingOverview : VM_Base
  {
    ...
    public VM_WeighingOverview(List<V_RawMaterialOverview> materialsBeforeScale, V_RawMaterialOverview materialOnScale,
      List<V_RawMaterialOverview> materialsAfterScale)
    {
