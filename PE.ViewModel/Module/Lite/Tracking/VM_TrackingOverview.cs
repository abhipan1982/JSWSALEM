...
namespace PE.HMIWWW.ViewModel.Module.Lite.Tracking
{
  public class VM_TrackingOverview : VM_Base
  {
    ...
    public VM_TrackingOverview(V_RawMaterialOverview data)
    {
      ...
      DimWorkOrderKey = data.WorkOrderId;
      DimHeatKey = data.HeatId;
      DimLastAssetKey = data.AssetId;
      DimRawMaterialStatusKey = data.EnumRawMaterialStatus;
      DimRawMaterialKey = data.RawMaterialId;
      DimProductKey = data.ProductId;
    ...
    {
      RawMaterialLastWeight = data.RawMaterialLastWeight;
      RawMaterialDeclaredWeight = data.MaterialWeight;
      RawMaterialLastLength = data.RawMaterialLastLength;
