...
namespace PE.HMIWWW.ViewModel.Module.Lite.Steelgrade
{
  public class VM_Steelgrade : VM_Base
  {
    ...
    public VM_Steelgrade(PRMSteelgrade sg)
    {
      ...
      CustomCode = sg.CustomCode;
      CustomDescription = sg.CustomDescription;
      CustomName = sg.CustomName;
      SteelFamilyId = sg.FKSteelGroupId;
      SteelFamilyCode = sg.FKSteelGroup?.SteelGroupCode;
      GroupDescription = sg.FKSteelGroup?.SteelGroupDescription;
      ParentSteelgradeId = sg.FKParentSteelgradeId;
      ParentSteelgradeCode = sg.FKParentSteelgrade?.SteelgradeCode;

      if (sg.FKScrapGroup != null)
      {
        FkScrapGroupId = sg.FKScrapGroup.ScrapGroupId;
        ScrapGroupCode = sg.FKScrapGroup.ScrapGroupCode;
      }
    ...
    [SmfDisplay(typeof(VM_Steelgrade), "SteelgradeCode", "NAME_Code")]
    [SmfStringLength(10)]
    [SmfRequired]
    public string SteelgradeCode { get; set; }

    [SmfDisplay(typeof(VM_Steelgrade), "SteelgradeName", "NAME_Steelgrade")]
    [SmfStringLength(50)]
    public string SteelgradeName { get; set; }

    [SmfDisplay(typeof(VM_Steelgrade), "ParentSteelgradeId", "NAME_ParentSteelgradeCode")]
    public long? ParentSteelgradeId { get; set; }
    ...
    [SmfFormat("FORMAT_Density", NullDisplayText = "-", HtmlEncode = false)]
    ...
    [SmfDisplay(typeof(VM_Steelgrade), "CustomerUseCode", "NAME_CustomCode")]
    [DisplayFormat(NullDisplayText = "-", HtmlEncode = false)]
    [SmfStringLength(10)]
    public string CustomCode { get; set; }

    [SmfDisplay(typeof(VM_Steelgrade), "CustomerUseDescription", "NAME_CustomName")]
    [DisplayFormat(NullDisplayText = "-", HtmlEncode = false)]
    [SmfStringLength(50)]
    public string CustomName { get; set; }

    [SmfDisplay(typeof(VM_Steelgrade), "CustomerUseDescription", "NAME_CustomDescription")]
    [DisplayFormat(NullDisplayText = "-", HtmlEncode = false)]
    [SmfStringLength(200)]
    public string CustomDescription { get; set; }

    [SmfDisplay(typeof(VM_Steelgrade), "SteelFamilyId", "NAME_SteelFamilyCode")]
    [DisplayFormat(NullDisplayText = "-", HtmlEncode = false)]
    public long? SteelFamilyId { get; set; }

    [SmfDisplay(typeof(VM_Steelgrade), "SteelFamilyCode", "NAME_SteelFamilyCode")]
    [DisplayFormat(NullDisplayText = "-", HtmlEncode = false)]
    public string SteelFamilyCode { get; set; }

    [SmfDisplay(typeof(VM_Steelgrade), "GroupDescription", "NAME_GroupDescription")]
    [DisplayFormat(NullDisplayText = "-", HtmlEncode = false)]
    public string GroupDescription { get; set; }

    [SmfDisplay(typeof(VM_Steelgrade), "FeMax", "NAME_SteelGradeCC_FeMin")]
    ...
    [DisplayFormat(NullDisplayText = "-", HtmlEncode = false)]
    [SmfDisplay(typeof(VM_Steelgrade), "ScrapGroupId", "NAME_ScrapGroupCode")]
    public long? FkScrapGroupId { get; set; }

    [DisplayFormat(NullDisplayText = "-", HtmlEncode = false)]
    [SmfDisplay(typeof(VM_Steelgrade), "ScrapGroupCode", "NAME_ScrapGroupCode")]
