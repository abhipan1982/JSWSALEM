...
// 
// Generated at: 09/15/2023 17:26:50
//
using System;
...

{
    ...
    [Serializable]
    public class CustomCommStatus : CommStatus
    {
        public static readonly CommStatus ProcessingError = GetInstance(-2, "ProcessingError");
        public static readonly CommStatus ValidationError = GetInstance(-1, "ValidationError");
        public static readonly CommStatus New = GetInstance(0, "New");
        public static readonly CommStatus BeingProcessed = GetInstance(1, "BeingProcessed");
        public static readonly CommStatus Processed = GetInstance(2, "Processed");
        ...
        public static CommStatus GetCustomValue(short input)
        {
            switch(input)
            {
