...
{
  public class DCL2L3ProductReportExt : BaseExternalTelegram
  {
    /// <summary>
    ...
    {
      DCL2L3ProductReport internalDc = (DCL2L3ProductReport)dc;

      Counter = internalDc.Counter;
      ...
      SequenceInWorkOrder = internalDc.SequenceInWorkOrder;
      ProductName = internalDc.ProductName;
      OutputWidth = internalDc.OutputWidth;
      OutputThickness = internalDc.OutputThickness;
      OutputWeight = internalDc.OutputWeight;
      ProductType = internalDc.ProductType;
      OutputPieces = internalDc.OutputPieces;
      InspectionResult = internalDc.InspectionResult;
