...
{
  public class DCL3L2WorkOrderDefinitionExtMOD : BaseExternalTelegram
  {
    /// <summary>
    ...
    public DCL3L2WorkOrderDefinitionExtMOD()
    {
        
    }
    
    public DCL3L2WorkOrderDefinitionExtMOD(L3L2WorkOrderDefinition data)
    {
    ...
    public override string ToString()
    {
      ...
      PropertyInfo[] properties = typeof(DCL3L2WorkOrderDefinitionExtMOD).GetProperties();
    ...
    {
      DCL3L2WorkOrderDefinitionMOD internalDc = (DCL3L2WorkOrderDefinitionMOD)dc;
