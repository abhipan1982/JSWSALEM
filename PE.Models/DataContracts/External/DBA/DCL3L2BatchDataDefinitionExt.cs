...
{
  public class DCL3L2BatchDataDefinitionExt : DataContractBase
  {
    /// <summary>
    ...
    {
      string output = "Generated BatchData L3 telegram:\n";
      PropertyInfo[] properties = typeof(DCL3L2BatchDataDefinitionExt).GetProperties();
    ...
    {
      return new DCL3L2BatchDataDefinitionExt()
      {
        ...
        Output_Material = this.Output_Material,
        Input_Material = this.Input_Material,
        RawMaterialShapeType = this.RawMaterialShapeType,
    ...
    public DCL3L2BatchDataDefinitionExt()
    {

    }

    public DCL3L2BatchDataDefinitionExt(L3L2BatchDataDefinition data)
    {
    ...
    {
      DCL3L2BatchDataDefinition dCL3L2BatchData = (DCL3L2BatchDataDefinition)dc;

      Counter = dCL3L2BatchData.Counter;
      CommStatus = dCL3L2BatchData.CommStatus;
      CreatedTs = dCL3L2BatchData.CreatedTs;
      BatchNo = dCL3L2BatchData.BatchNo?.Trim();     
