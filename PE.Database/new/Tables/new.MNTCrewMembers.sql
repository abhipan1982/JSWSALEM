CREATE TABLE [new].[MNTCrewMembers] (
    ...
    CONSTRAINT [FK_MNTCrewMembers_MNTMembers] FOREIGN KEY ([FKMemberId]) REFERENCES [new].[MNTMembers] ([MemberId])
);
...
-- =============================================
CREATE   TRIGGER [new].[TR_MNTCrewMembers_Audit] ON [new].[MNTCrewMembers] AFTER INSERT, UPDATE, DELETE AS
BEGIN
    SET NOCOUNT ON;
