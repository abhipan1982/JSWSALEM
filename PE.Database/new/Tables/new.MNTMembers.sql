CREATE TABLE [new].[MNTMembers] (
    ...
    CONSTRAINT [FK_MNTMembers_MNTMemberRoles] FOREIGN KEY ([FKMemberRoleId]) REFERENCES [new].[MNTMemberRoles] ([MemberRoleId]),
...
-- =============================================
CREATE   TRIGGER [new].[TR_MNTMembers_Audit] ON [new].[MNTMembers] AFTER INSERT, UPDATE, DELETE AS
BEGIN
    SET NOCOUNT ON;
