CREATE PROCEDURE [dbo].[SPKPIMetallicYield] @TimeFrom DATETIME = NULL, 
                                           @TimeTo   DATETIME = NULL, 
                                           @KPIValue FLOAT    = NULL OUTPUT
AS

/*
EXECUTE dbo.SPKPIMetallicYield @TimeFrom = '2022-02-01 00:00:00.000', @TimeTo='2022-02-03 12:00:00.000'
...
*/
    ...
    BEGIN TRY
        ...
        SELECT @KPIValue = CASE
                               ...
                               THEN SUM(ProductWeight) / SUM(MaterialWeight)
                               ELSE 0
                           END
