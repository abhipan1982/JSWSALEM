...
using PE.TCP.TcpProxy.Handlers;
...
namespace PE.TCP.TcpProxy.Managers
{
  public class TcpListenerProxyManager : ITcpListenerProxyManager
  {
    #region members

    protected readonly ITcpProxySendOffice SendOffice;

    #endregion

    #region ctor

    public TcpListenerProxyManager(ITcpProxySendOffice sendOffice)
    {
