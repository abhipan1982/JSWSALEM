...
{
  public class Banding : TrackingNonPositionRelatedQueueBase
  {
    #region ctor

    public Banding(int queueSize, int assetCode, TrackingEventType trackingEventType,
    ...
    private static event L1TrackingQueuePositionChangeEventHandler L1TrackingQueuePositionChangeEvent;
    private static event SendTrackingEventEventHandler SendTrackingEvent;
    ...
    public static event L1TrackingQueuePositionChangeEventHandler OnL1TrackingQueuePositionChangeEvent
    {
      add
      {
        ...
        {
          L1TrackingQueuePositionChangeEvent += value;
        }
      }
      remove
      {
    ...
    private TrackingQueueElementBase DischargeMaterial()
    {
      lock (LockObject)
      {
        ...
        if (position == null)
        {
          throw new Exception("For DischargeElement operation in Banding Area should be at least one material");
        }
