...
{
  public class CoilInspectionStationController : BaseController
  {
    private readonly IInspectionService _inspectionService;

    public CoilInspectionStationController(IInspectionService service)
    {
    ...
    public ActionResult Index()
    {
      ...
      return View("~/Views/Module/PE.Lite/CoilInspectionStation/Index.cshtml");
    }
    ...
    public Task<JsonResult> GetRawMaterialSearchList([DataSourceRequest] DataSourceRequest request)
    {
      return PrepareJsonResultFromDataSourceResult(() =>
        _inspectionService.GetCoilInspectionStationRawMaterialSearchList(ModelState, request));
    }
    ...
    public Task<ActionResult> ElementDetails(long rawMaterialId)
    {
      return PrepareActionResultFromVm(() => _inspectionService.GetRawMaterialDetails(ModelState, rawMaterialId),
        "~/Views/Module/PE.Lite/CoilInspectionStation/_InspectionBody.cshtml");
    }
    ...
    public Task<ActionResult> RawMaterialQualityView(long rawMaterialId)
    {
      return PrepareActionResultFromVm(() => _inspectionService.GetQualityByRawMaterial(rawMaterialId),
        "~/Views/Module/PE.Lite/CoilInspectionStation/_Quality.cshtml");
    }
    ...
    public ActionResult ScrapByRawMaterialView(long id)
    {
      ...
      return PartialView("~/Views/Module/PE.Lite/CoilInspectionStation/_Scrap.cshtml", scrapData);
    }
    ...
    {
      return PrepareActionResultFromVm(() => _inspectionService.GetQualityByRawMaterial(rawMaterialId),
        "~/Views/Module/PE.Lite/CoilInspectionStation/_Inspection.cshtml");
    }
