...
namespace PE.HMIWWW.Controllers.Module.PE.Lite
{
  public class EquipmentGroupsController : BaseController
  {
    ...
    public Task<ActionResult> EquipmentGroupsEditPopupAsync(long id)
    {
      return PreparePopupActionResultFromVm(() => _service.GetEquipmentGroup(id), "~/Views/Module/PE.Lite/EquipmentGroup/_EquipmentGroupsEditPopup.cshtml");
    }
    ...
    [SmfAuthorization(Constants.SmfAuthorization_Controller_EquipmentGroups, Constants.SmfAuthorization_Module_Maintenance, RightLevel.Update)]
    public Task<ActionResult> EquipmentGroupCreatePopup()
    {
      return PreparePopupActionResultFromVm(() => _service.GetEmptyEquipmentGroup(), "~/Views/Module/PE.Lite/EquipmentGroup/_EquipmentGroupsCreatePopup.cshtml");
