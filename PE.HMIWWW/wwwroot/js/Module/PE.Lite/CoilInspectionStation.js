...
var columns = ["MaterialCreatedTs", "MaterialStartTs", "MaterialEndTs", "ProductCreatedTs", "RollingStartTs", "RollingEndTs", "HeatName", "CreatedTs", "LastUpdateTs", "WorkOrderName"];
...
function onElementSelect(e) {
  ...
  var url = "/CoilInspectionStation/ElementDetails";
...
function editDefectPopup(defectId) {
  ...
  OpenInPopupWindow({
    controller: "CoilInspectionStation", method: "DefectEditPopup", width: 480, data: { id: defectId }, afterClose: afterDefectUpdate
  });
}
...
function deleteDefect(itemId) {
  ...
  let url = 'CoilInspectionStation/DeleteDefect'
...
function refreshQuality() {
  ...
  let url = "/CoilInspectionStation/QualityView";
...
function refreshScrap() {
  ...
  let url = "/CoilInspectionStation/ScrapByRawMaterialView";
