...
namespace PE.BaseInterfaces.Modules
{
  ...
  public interface IRollShopBase : IBaseModule
  {
    /////////////
    ///ROLLS MANAGEMENT
    /////////////
    ...
    [OperationContract]
    [FaultContract(typeof(ModuleMessage))]
    Task<DataContractBase> DismountCassetteAsync(DCCassetteData message);
    ...
    [OperationContract]
    [FaultContract(typeof(ModuleMessage))]
    Task<DataContractBase> UpdateGroovesDataToRollSetAsync(DCRollSetGrooveSetup message);
